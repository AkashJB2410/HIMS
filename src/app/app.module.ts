...
import { PatientConfigCountryComponent } from './features/patient-config-country/patient-config-country.component';
import { PatientConfigStateComponent } from './features/patient-config-state/patient-config-state.component';
import { PatientConfigDistrictComponent } from './features/patient-config-district/patient-config-district.component';
import { PatientConfigCityComponent } from './features/patient-config-city/patient-config-city.component';
import { PatientConfigVillageComponent } from './features/patient-config-village/patient-config-village.component';
