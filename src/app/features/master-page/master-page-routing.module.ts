...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'PatientConfigCountry', loadChildren: () => import('../patient-config-country/patient-config-country.module').then(m => m.PatientConfigCountryModule) },
      { path: 'PatientConfigState', loadChildren: () => import('../patient-config-state/patient-config-state.module').then(m => m.PatientConfigStateModule) },
      { path: 'PatientConfigDistrict', loadChildren: () => import('../patient-config-district/patient-config-district.module').then(m => m.PatientConfigDistrictModule) },
      { path: 'PatientConfigCity', loadChildren: () => import('../patient-config-city/patient-config-city.module').then(m => m.PatientConfigCityModule) },
      { path: 'PatientConfigVillage', loadChildren: () => import('../patient-config-village/patient-config-village.module').then(m => m.PatientConfigVillageModule) },
