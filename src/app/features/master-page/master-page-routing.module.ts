...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'opd-registration', loadChildren:()=> import('./../opd-registration/opd-registration.module').then(m=>m.OpdRegistrationModule)},
      { path: 'ipd-registration', loadChildren:()=> import('./../opd-registration/opd-registration.module').then(m=>m.OpdRegistrationModule)},
