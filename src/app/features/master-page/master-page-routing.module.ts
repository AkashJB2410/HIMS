...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'all-masters/clinical-forms', loadChildren: () => import('./../clinical-forms/clinical-forms.module').then(m => m.ClinicalModule) },
      { path: 'all-masters/clinical-procedure', loadChildren: () => import('./../clinical-procedure/clinical-procedure.module').then(m => m.ClinicalProcedureModule) },
      { path: 'all-masters/disease-sub-category', loadChildren: () => import('./../disease-sub-category/disease-sub-category.module').then(m => m.DiseaseModule) },
      { path: 'all-masters/document-category', loadChildren: () => import('./../document-category/document-category.module').then(m => m.DocumentCategoryModule) },
      { path: 'all-masters/icd-code', loadChildren: () => import('./../icd-code/icd-code.module').then(m => m.IcdCodeModule) },
      { path: 'all-masters/procedure', loadChildren: () => import('./../procedure/procedure.module').then(m => m.ProcedureModule) },
      { path: 'all-masters/template', loadChildren: () => import('./../template/template.module').then(m => m.TemplateModule) },
