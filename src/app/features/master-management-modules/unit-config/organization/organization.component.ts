...
export class OrganizationComponent implements OnInit {
  ...
  isActive(data: any) {
    if (!data.isActive) {
      this.http
        .reactiveData(this.apiactive, data, data.orgId)
        .subscribe((b_Data) => {
          this.data = undefined;
          this.getAllOrgData();
        });
      this.messageService.add({
        severity: 'success',
        summary: 'Enable',
        detail: 'Organization Enable Successfully',
      });
  ...
  submitOrgData(orgData: any) {
    ...
    this.http.addData(orgData, this.apiAdd).subscribe((data) => {
      this.data = undefined;
      this.getAllOrgData();
  ...
  updateOrgData(orgData: any) {
    this.http.updateData(orgData, this.apiUpdate).subscribe((data) => {
      this.data = undefined;
      this.getAllOrgData();
      console.log('data' + data);
    });
  ...
  deleteOrgData(orgData: any) {
    this.http.deleteData(this.apidelete, orgData.orgId).subscribe((data) => {
      this.data = undefined;
      this.getAllOrgData();
      console.log('data' + data);
    });
  ...
  confirmAction(e: any) {
    if (e.isActive == true) {
      ...
      this.messageService.add({
        severity: 'success',
        summary: 'Disabled',
        detail: 'Organization Disabled Successfully',
      });
    } else {
      this.messageService.add({
        severity: 'error',
        summary: 'Error',
        detail: 'Organization is already Disabled',
      });
    }
  }
