...
import document_Categorys_Table_Config from './document-categorys-tableConfig.json';
import document_categorys_Form from './document-categorys.json';
import breadcrumb from './document-categorys-breadcrumb.json';

@Component({
  selector: 'app-document-categorys',
  templateUrl: './document-categorys.component.html',
  styleUrls: ['./document-categorys.component.css']
})
export class DocumentCategorysComponent implements OnInit {

     // orgDetails:any
     addnewss:any = document_categorys_Form;
     configurations: any
     data:any;
     config: any;
     ...
     getConfigForTable() {    
       this.config = document_Categorys_Table_Config;
     }
