...
import  breadcrumb  from './templates-breadcrumb.json';
import templates_Table_Config from './templates-tableConfig.json';
import templates_Form from './templates.json'
...
export class TemplatesComponent implements OnInit {
  ...
  getConfigForTable() {    
    this.config = templates_Table_Config;
  }
