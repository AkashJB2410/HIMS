...
import icd_Code_Master_Table_Config from './icd-code-master-tableConfig.json';
import icd_Code_Form from './icd-code-master.json';
import breadcrumb from './icd-code-master-breadcrumb.json';

@Component({
  selector: 'app-icd-code-master',
  templateUrl: './icd-code-master.component.html',
  styleUrls: ['./icd-code-master.component.css']
})
export class IcdCodeMasterComponent implements OnInit {

   // orgDetails:any
   addnewss:any = icd_Code_Form;
   configurations: any
   data:any;
   config: any;
   ...
   getConfigForTable() {    
     this.config = icd_Code_Master_Table_Config;
   }
