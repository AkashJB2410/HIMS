...
import procedures_Table_Config from './procedures-tableConfig.json';
import procedures_Form from './procedures.json';
import breadcrumb from './procedures-breadcrumb.json';
...
export class ProceduresComponent implements OnInit {
  ...
  editData:any;
  apiGet="mstProcedure/list";
  apiAdd="mstProcedure/create";
  apiUpdate="mstProcedure/update";
  apidelete="mstProcedure/inActivate";
  apiactive="mstProcedure/activate";
  ...
  getConfigForTable() {    
    this.config = procedures_Table_Config;
  }
