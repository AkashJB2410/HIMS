...
import breadcrumb from './clinical-procedure-breadcrumb.json';
import clinical_Procedure_Table_Config from './clinical-procedure-tableConfig.json';
import clinical_pocedure_Form from './clinical-procedure.json'

@Component({
  selector: 'app-clinical-procedures',
  templateUrl: './clinical-procedures.component.html',
  styleUrls: ['./clinical-procedures.component.css']
})
export class ClinicalProceduresComponent implements OnInit {

  
  // orgDetails:any
  addnewss:any = clinical_pocedure_Form;
  configurations: any
  data:any;
  config: any;
  ...
  editData:any;
  apiGet="mstClinicalProcedure/list";
  apiAdd="mstClinicalProcedure/create";
  apiUpdate="mstClinicalProcedure/update";
  apidelete="mstClinicalProcedure/inActivate";
  apiactive="mstClinicalProcedure/activate";
  ...
  getConfigForTable() {    
    this.config = clinical_Procedure_Table_Config;
  }
